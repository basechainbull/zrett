...
class Projectile{
    ...
    draw(){
        ...
        // ctx.fill();
        ctx.drawImage(projectile, this.frameX * this.spriteWidth , 0 ,this.spriteWidth,this.spriteHeight, this.x + 30, this.y - 30,this.width,this.height)
...
defenderShooting.src = 'defender.png'

const defenderIdle = new Image();
defenderIdle.src = 'defender-idle.png'
const defenderMap = {
    idle: {
        type: defenderIdle,
        maxFrame: 9
...
function handleResources(){
    ...
    for(let i = 0; i< resources.length; i++){
        ...
        if(resources[i] && mouse.x && mouse.y && collision(resources[i],mouse)){
            ...
            floatingMessages.push(new FloatingMessage("+" + resources[i].amount, 250, 50, 30,"orange"))
...
function handleGameStatus(){
    ...
    if(score >= winningScore && enemies.length === 0 ){
        ...
        ctx.fillText("LEVEL COMPLETE", 130, 180)
        ctx.font = "30px Orbitron";
